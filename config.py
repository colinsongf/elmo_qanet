...
#train_file = "/data/20180827_comma/datasets/squad/wikihop.train.qplusa.withcand.squad.json"
#dev_file = "/data/20180827_comma/datasets/squad/wikihop.dev.cand.withcand.squad.new.json"
#test_file ="/data/20180827_comma/datasets/squad/wikihop.dev.cand.withcand.squad.new.json"
train_file = "/data/20180827_comma/datasets/squad/20180828_true_periond_wikihop.train.qplusa.withcand.squad.json"
dev_file = "/data/20180827_comma/datasets/squad/20180828_true_periond_wikihop.dev.cand.withcand.squad.new.json"
test_file ="/data/20180827_comma/datasets/squad/20180828_true_periond_wikihop.dev.cand.withcand.squad.new.json"
#train_file = "/data/20180827_comma/datasets/squad/paragraph.allanswers.wikihop.train.qplusa.withcand.squad.json"
#dev_file = "/data/20180827_comma/datasets/squad/paragraph.allanswers.wikihop.dev.cand.withcand.squad.new.json"
#test_file ="/data/20180827_comma/datasets/squad/paragraph.allanswers.wikihop.dev.cand.withcand.squad.new.json"
#train_file = "/data/20180827_comma/datasets/squad/sentences.allanswers.wikihop.train.qplusa.withcand.squad.json"
#dev_file = "/data/20180827_comma/datasets/squad/sentences.allanswers.wikihop.dev.cand.withcand.squad.new.json"
#test_file ="/data/20180827_comma/datasets/squad/sentences.allanswers.wikihop.dev.cand.withcand.squad.new.json"
glove_word_file = "/data/20180827_comma/datasets/glove/glove.840B.300d.txt"

train_dir = "/data/QANet_three_attention_elmo_output_with_period_prepro__20180910"
model_out_path = train_dir
...
flags.DEFINE_integer("test_ques_limit", 30, "Limit length for question in test file")
...
flags.DEFINE_integer("num_steps", 900000, "Number of steps") # 250000
